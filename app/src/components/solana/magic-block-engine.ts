// Copied from https://github.com/magicblock-labs/solana-generals/blob/main/frontend/src/engine/MagicBlockEngine.ts
...
import { RPC_URL, RPC_URL_WSS } from "@/lib/constants";

export const ENDPOINT_CHAIN_RPC = RPC_URL;
export const ENDPOINT_CHAIN_WS = RPC_URL_WSS;

export const _ENDPOINT_CHAIN_RPC = "http://127.0.0.1:7899";
export const _ENDPOINT_CHAIN_WS = "ws://127.0.0.1:7900";

export const ENDPOINT_EPHEM_RPC = "https://devnet.magicblock.app";
export const ENDPOINT_EPHEM_WS = "wss://devnet.magicblock.app:8900";

export const _ENDPOINT_EPHEM_RPC = "http://localhost:8899";
export const _ENDPOINT_EPHEM_WS = "ws://localhost:8900";

export const TRANSACTION_COST_LAMPORTS = 5000;
...
export class MagicBlockEngine {
  ...
  getWalletPayer(): PublicKey | null {
    return this.walletContext.publicKey ?? null;
  }
  ...
  subscribeToAccountInfo(
    ...
    connection.getAccountInfo(address).then(
      (accountInfo) => {
        ...
        onAccountChange(accountInfo ?? undefined);
      },
      (error) => {
